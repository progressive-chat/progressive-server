...
// NEW in 71500b1: get participating servers in a room
  ...
  /// Kick a user from a room (sets membership to leave with reason)
  bool room_kick(const std::string& sender, const std::string& room_id,
                 const std::string& user_id,
                 const std::optional<std::string>& reason = std::nullopt);
  /// Ban a user from a room (sets membership to ban with reason)
  bool room_ban(const std::string& sender, const std::string& room_id,
                const std::string& user_id,
                const std::optional<std::string>& reason = std::nullopt);
  /// Unban a user (sets membership to leave with reason)
