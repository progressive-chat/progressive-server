...
Database::Database(sled::Tree up, MultiValue ud, sled::Tree ut, sled::Tree tu,
                   ...
                   MultiValue ui, sled::Tree dn, MultiValue ul,
                    sled::Tree mf, sled::Tree mf_meta, sled::Tree mf_blocked,
                    sled::Tree mf_blocked_hash, sled::Tree ua,
      ...
      media(std::move(mf), std::move(mf_meta), std::move(mf_blocked),
            std::move(mf_blocked_hash)),
      uiaa(std::move(ua)),
      alias_roomid(std::move(ar)),
      alias_creator(std::move(ac)),
      ...
      backupkeyid_backup(std::move(bb)),
       ...
       openidtoken_userid(std::move(ot)),
        admin_users(std::move(au)),
         ...
         userdeviceid_devicekey(std::move(userdeviceid_devicekey)),
         userdeviceid_onetimekey(std::move(userdeviceid_onetimekey)),
         userdeviceid_lastseen(std::move(userdeviceid_lastseen)),
         appserviceid_registration(std::move(appserviceid_registration)),
         appservice_token_id(std::move(appservice_token_id)) {}
...
Database Database::open(sled::Db* db) {
  return Database(db->open_tree("userid_password"),
                  ...
                  db->open_tree("mediaid_meta"),
                  db->open_tree("blocked_servername_mediaid"),
                  db->open_tree("blocked_filehash"),
                  db->open_tree("userdeviceid_uiaainfo"),
                  db->open_tree("alias_roomid"),
                  db->open_tree("alias_creator"),
                  ...
                  db->open_tree("backup_latest"),
                   ...
                   db->open_tree("userdeviceid_devicekey"),
                   db->open_tree("userdeviceid_onetimekey"),
                   db->open_tree("userdeviceid_lastseen"),
                   db->open_tree("appserviceid_registration"),
                   db->open_tree("appservice_token_id"));
}
